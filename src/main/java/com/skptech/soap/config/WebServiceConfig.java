package com.skptech.soap.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public ServletRegistrationBean messageDispatcherServlet(ApplicationContext applicationContext) {
        ...
        return new ServletRegistrationBean(dispatcherServlet, "/service/*");
    }
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema employeeSchema) {
        ...
        wsdl11Definition.setServiceName("/service/employee");
        wsdl11Definition.setTargetNamespace("http://www.skptech.com/xml/employee");
